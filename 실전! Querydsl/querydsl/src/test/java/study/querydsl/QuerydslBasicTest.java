...
public class QuerydslBasicTest {
    ...
    public void startJPQL() {
        ...
        // member1 찾기
        String qString = "select m from Member" +
...
//        assertThat(result.size()).isEqualTo(2);
    ...
    public void concat() {
        ...
        // username_age 형식으로 출력하고 싶어 -> 그런데 age는 타입이 String이 아니야
        // Enum 처리할 때도 .stringValue() 사용
        List<String> result = queryFactory
    ...
    public void findDtoByJPQL() {
        String s = "select new study.querydsl.dto.MemberDto(m.username, m.age) from Member m";
        List<MemberDto> result = em.createQuery(s, MemberDto.class)
                .getResultList();
